...
import { BUIDLEREVM_NETWORK_NAME } from "@redspot/buidler/internal/constants";
import { parseDateString } from "@redspot/buidler/internal/util/date";
...
export function createProvider(
  ...
  if (networkName === BUIDLEREVM_NETWORK_NAME) {
    ...
    const {
      BuidlerEVMProvider,
    } = require("@redspot/buidler-evm/provider/provider");
