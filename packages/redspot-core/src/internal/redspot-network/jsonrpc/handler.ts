...
const _handleError = (error: any): JsonRpcResponse => {
  // In case of non-redspot error, treat it as internal and associate the appropriate error code.
  if (!RedspotNetworkProviderError.isRedspotNetworkProviderError(error)) {
