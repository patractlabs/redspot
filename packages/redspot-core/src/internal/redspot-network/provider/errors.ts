...
export class RedspotNetworkProviderError extends CustomError
  implements ProviderRpcError {
  public static isRedspotNetworkProviderError(
    other: any
  ): other is RedspotNetworkProviderError {
    return (
      other !== undefined &&
      other !== null &&
      other._isRedspotNetworkProviderError === true
    );
  }

  private readonly _isRedspotNetworkProviderError: boolean;

  constructor(message: string, public readonly code: number) {
    super(message);

    this._isRedspotNetworkProviderError = true;
  }
}

export class InvalidJsonInputError extends RedspotNetworkProviderError {
...
export class InvalidRequestError extends RedspotNetworkProviderError {
...
export class MethodNotFoundError extends RedspotNetworkProviderError {
...
export class InvalidArgumentsError extends RedspotNetworkProviderError {
...
export class InternalError extends RedspotNetworkProviderError {
...
export class InvalidInputError extends RedspotNetworkProviderError {
...
export class TransactionExecutionError extends RedspotNetworkProviderError {
...
export class MethodNotSupportedError extends RedspotNetworkProviderError {
