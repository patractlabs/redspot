...
export const rpcRedspotNetworkConfig = t.type(
  {
...
export type RpcRedspotNetworkConfig = t.TypeOf<typeof rpcRedspotNetworkConfig>;

export const optionalRpcRedspotNetworkConfig = optional(
...
export function validateParams(
  params: any[],
  forkConfig: typeof optionalRpcRedspotNetworkConfig
): [RpcRedspotNetworkConfig | undefined];
