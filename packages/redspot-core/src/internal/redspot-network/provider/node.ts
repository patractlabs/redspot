...
const log = debug('redspot:core:redspot-network:node');
...
export class RedspotNode extends EventEmitter {
  public static async create(
    config: NodeConfig
  ): Promise<[Common, RedspotNode]> {
    const {
      genesisAccounts,
      blockGasLimit,
    ...
    let blockchain: RedspotBlockchain | ForkBlockchain;
    ...
    if (config.type === 'forked') {
      ...
      blockchain = new RedspotBlockchain();
  ...
  private constructor(
    ...
    try {
      ...
      console.warn(
        chalk.yellow(
          'The Redspot Network tracing engine could not be initialized. Run Redspot with --verbose to learn more.'
        )
      );

      log(
        'Redspot Network tracing disabled: ContractsIdentifier failed to be initialized. Please report this to help us improve Redspot.\n',
        error
      );
  ...
  public async addCompilationResult(
    ...
    try {
      ...
      console.warn(
        chalk.yellow(
          'The Redspot Network tracing engine could not be updated. Run Redspot with --verbose to learn more.'
        )
      );

      log(
        'ContractsIdentifier failed to be updated. Please report this to help us improve Redspot.\n',
        error
      );
  ...
  private async _getConsoleLogMessages(
    ...
    if (vmTrace === undefined || vmTracerError !== undefined) {
      log(
        'Could not print console log. Please report this to help us improve Redspot.\n',
        vmTracerError
      );
  ...
  private async _manageErrors(
    ...
    try {
      ...
      log(
        'Could not generate stack trace. Please report this to help us improve Redspot.\n',
        error
      );
    }
